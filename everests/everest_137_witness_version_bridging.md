# Everest 137 | ZKAC Bridging Across Witness Versions

**Canonical v0:** [`ZKAC_WITNESS_VERSION_BRIDGE_v0.md`](../ZKAC_WITNESS_VERSION_BRIDGE_v0.md). This file is the Everest narrative companion.

**Closes Everest 137 of [`ZKAC_NEXT_200_EVERESTS.md`](../ZKAC_NEXT_200_EVERESTS.md).**

**Draft v0 · 2026-05-20 · Calm**

**Prereq:** Everest 121 ([`ZKAC_TYPE_SYSTEM_v0.md`](../ZKAC_TYPE_SYSTEM_v0.md)), [`ZKBB_USER_PROTOCOL_v0.md`](../ZKBB_USER_PROTOCOL_v0.md), [`PREDICATE_VOCABULARY_v0.md`](../PREDICATE_VOCABULARY_v0.md).
...
This Everest specifies **Calm Witness primitive bridging only**. CredexAI platform bridging is Everest 135. Pact and Compass wire bumps are Everests 136 and 138. Shared window discipline lives in [`ZKAC_VERSION_BRIDGING_v0.md`](../ZKAC_VERSION_BRIDGING_v0.md) §3.
...
| Term | Meaning |
| --- | --- |
| **Witness wire v0** | Wire label `calm-witness/wire/v0`. Witness-only `DisclosureEnvelope` layout per early reference impl. |
...
Biometric template supersession ([`everest_17_template_version_migration.md`](everest_17_template_version_migration.md)) uses `kind: template.migration`. Chain schema migration is orthogonal: a vault may migrate chain layout without rotating templates, and vice versa. Both records MUST appear on the chain when both events occur.
...
| This Everest (137 only) | [`everest_137_witness_version_bridging.md`](everest_137_witness_version_bridging.md) |
...
| Everest 137 gate | [`~/CredexAI/scripts/everest_137_zkac_witness_version_bridging_gate.py`](../../CredexAI/scripts/everest_137_zkac_witness_version_bridging_gate.py) |
