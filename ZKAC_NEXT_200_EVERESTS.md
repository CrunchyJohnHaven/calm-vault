...
**Everest 180 — Long-term forensic integrity.** *Acceptance:* any vault can be cryptographically reconstructed from its chain + transparency-log entries 10+ years after creation. *Effort:* L. *Prereq:* 165. *Status:* **DESIGN-BAGGED (Summit 180/300) 2026-05-20** — [`FORENSIC_INTEGRITY_10YR_GUARANTEE_v0.md`](FORENSIC_INTEGRITY_10YR_GUARANTEE_v0.md), three-outcome promise (verified-true / verified-false / inconclusive), 8-step reconstruction protocol, PQ-degradation handling.
