...
**Companion to [`COMPASS_PREDICATES_v0.md`](COMPASS_PREDICATES_v0.md), [`COMPASS_EVIDENCE_CEREMONY_v0.md`](COMPASS_EVIDENCE_CEREMONY_v0.md), and [`COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md`](COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md).**
...
**Counter-claim:** A third party Q can file a counter-claim alleging the act was actually selfish or never happened. Principal P has 30 days to file a rebuttal per [`COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md`](COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md) (Everest 111).
...
- P has 30 days to file a rebuttal (see [`COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md`](COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md) §3).
...
## §8 — Kind index (six ceremony kinds)
...
Principal rebuttals (`compass_evidence.principal_rebuttal`) are specified in [`COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md`](COMPASS_COUNTER_CLAIM_PROTOCOL_v0.md), not in this taxonomy.
...
1. **All six kinds present:** compass_evidence.unselfish_act, cross_group_interaction, refused_harm, respect_engagement, correction_accepted, counter_claim.
